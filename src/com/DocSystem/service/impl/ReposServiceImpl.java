...
public class ReposServiceImpl implements ReposService {  
	...
	public List<Doc> docData(HashMap<String, Object> params)
	{
		return docDao.docData(params);
	}

	public int docDataCount(HashMap<String, Object> params) {
		// TODO Auto-generated method stub
		return docDao.docDataCount(params);
	}
	public List<Doc> reposData() {
		// TODO Auto-generated method stub
		return docDao.reposData();
	}
}  
